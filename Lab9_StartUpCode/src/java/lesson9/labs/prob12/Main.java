...
import static lesson9.labs.prob12.LambdaLibrary.getUppercasedList;
import static lesson9.labs.prob12.LambdaLibrary.getNumberOfEmployees;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getNumberOfEmployees.apply(list));
        ...
        System.out.println(getUppercasedList.apply(list));
    }
