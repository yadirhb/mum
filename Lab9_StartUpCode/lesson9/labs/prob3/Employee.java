...
public class Employee {
    ...
    static Function<List<Employee>, List<Employee>> sortEmployee = (l) -> l.stream().sorted(Comparator.comparing(Employee::getName).thenComparing(Employee::getSalary)).collect(Collectors.toList());
